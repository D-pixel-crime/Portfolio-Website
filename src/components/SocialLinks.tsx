...
const SocialLinks = ({ footer }: { footer: Content.FooterDocument }) => {
  return (
    <footer
      className={`sm:fixed social-links sm:right-0 sm:top-[50%] sm:translate-y-[-50%] z-50 sm:px-3 sm:rounded-l-xl block py-4 max-sm:py-7 sm:bg-slate-800 max-sm:bottom-0`}
    >
      <div>
