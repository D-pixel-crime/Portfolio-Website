...
const Biography = ({ slice }: BiographyProps): JSX.Element => {
  return (
    <CommonBounded
      ...
      className="border-b-2 border-slate-700 pb-20 md:mx-5"
    >
      <div className="grid gap-x-14 gap-y-6 md:grid-cols-[1fr,2fr]">
        ...
        <div className="flex-center flex-col prose prose-xl max-sm:prose-base prose-slate prose-invert md:col-start-2 text-justify">
